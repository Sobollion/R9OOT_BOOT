...
@ECHO ******** Launching BASE BOOTLOADER 3 flashing process with OpenOCD (STLink v2)...
@ECHO .
@CD resources
@CD OpenOCD
@openocd -f interface/stlink.cfg -f target/dp32g030.cfg -c "uv_flash_bl R9OOT_BASE_BOOTLOADER_3.bin" -c "shutdown"
@PAUSE
